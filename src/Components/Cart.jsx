...
<div className='flex flex-col gap-6 border-b-[1px] border-b-gray-400 pb-6'>
  ...
  <span className='font-title font-bold text-lg'>
    ...
    <p className='flex items-start gap-4 text-base'>Shipping <span>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Unde, asperiores.</span></p>
</div>
<p className=' font-title font-semibold flex justify-between mt-6'> Total <span className='text-xl font-bold '>$ {total}
  </span></p>
